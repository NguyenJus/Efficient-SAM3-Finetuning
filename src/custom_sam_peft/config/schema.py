...
class BoxHintSchedule(_Strict):
    ...
    p_start: float = Field(default=1.0, ge=0.0, le=1.0)  # cite: degenerate-case (max probability)
    p_end: float = Field(default=0.0, ge=0.0, le=1.0)  # cite: degenerate-case (min probability)
    ...
    )  # tbd: #191 (0.75 decay fraction is project-chosen; cross-ref issue #88)
